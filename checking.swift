            ...
            VStack {
                ...
                Button(action: {
                    if IngredientsManager.ingredients.isEmpty {
                        ...
                        AddDietBreakFast(foodName: foodName , SodiumContent : sodiumContent , PotassiumContent : potassiumContent )
